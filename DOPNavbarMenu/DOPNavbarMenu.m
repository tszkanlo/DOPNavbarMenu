...
- (void)showInNavigationController:(UINavigationController *)nvc tableView:(UITableView *)tableView {
...
- (void)dismissMenu {
    [self dismissWithAnimation:YES tableView:[[UITableView alloc]init]];
}
